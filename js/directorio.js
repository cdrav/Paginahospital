...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const directorioData = [
       ...
       { nombre: "Julian Hernandez", cargo: "Asesor Jurídico", email: "notificacionesjudiciales@hdsa.gov.co", foto: "julian-hernandez.jpg", area: "asesor" },
        ...
        { nombre: "Diana Marcela Benitez", cargo: "Promoción y Prevención", email: "pyp@hdsa.gov.co", foto: "diana-Marcela-Benitez.jpg", area: "asistencial" },
        ...
        { nombre: "Lorena Nieto", cargo: "Enfermera", email: "enfermeria@hdsa.gov.co", foto: "lorena-nieto.jpg", area: "asistencial" },
        ...
        { nombre: "Sebastian Sarria", cargo: "Biomédico", email: "biomedico@hdsa.gov.co", foto: "sebastian-sarria.jpg", area: "asistencial" },
        { nombre: "Amalia Diaz", cargo: "Técnico Área Salud", email: "facturacion@hdsa.gov.co", foto: "amalia-diaz.jpg", area: "asistencial" },
